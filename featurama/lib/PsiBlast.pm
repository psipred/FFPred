...
sub new
{
    my ($class, $iter, $mask, $exe_path, $in, $db, $evalue, $hvalue) = @_;
    $evalue = 10.0 unless ($evalue); # blastpgp default value.
    $hvalue = 0.002 unless ($hvalue); # blastpgp default value.
    ...
    bless $self, $class; # Need to do it up here as we are going to call methods now.
